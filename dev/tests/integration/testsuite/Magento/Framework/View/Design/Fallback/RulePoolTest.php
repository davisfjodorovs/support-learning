...
class RulePoolTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function getPatternDirsDataProvider()
    {
        ...
        $themeOnePath = BP . '/dev/tests/integration/testsuite/Magento/Framework/layout/_files/fallback/design/frontend/'
            . 'Vendor/custom_theme';
        $themeTwoPath = BP . '/dev/tests/integration/testsuite/Magento/Framework/layout/_files/fallback/design/frontend/'
            . 'Vendor/default';
        $modulePath = BP . '/dev/tests/integration/testsuite/Magento/Framework/layout/_files/fallback/app/code/'
            . 'ViewTest_Module';
