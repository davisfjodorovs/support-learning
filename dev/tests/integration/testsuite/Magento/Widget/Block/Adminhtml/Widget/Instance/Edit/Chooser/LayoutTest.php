...
class LayoutTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $pageTypeValues = [
            ...
            'cms_index_nocookies' => ['label' => 'CMS No-Cookies ExampleViewModel', 'id' => 'cms_index_nocookies'],
            'cms_index_defaultindex' => ['label' => 'CMS Home Default ExampleViewModel', 'id' => 'cms_index_defaultindex'],
        ];
        ...
        $this->_block = new \Magento\Widget\Block\Adminhtml\Widget\Instance\Edit\Chooser\Layout(
            ...
            [
                ...
                'title' => 'ExampleViewModel Types Select'
            ]
        );
    }
