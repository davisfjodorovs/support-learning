...
$status->setData('status', 'custom_new_status')->setData('label', 'Xindex Status')->save();
$status->assignState(\Magento\Sales\Model\Order::STATE_NEW, true);
//status for state canceled
$status->setData('status', 'custom_canceled_status')->setData('label', 'Xindex Status')->unsetData('id')->save();
