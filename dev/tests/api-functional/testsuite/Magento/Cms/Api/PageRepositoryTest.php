...
{
    private const PAGE_TITLE = 'ExampleViewModel title';
    private const PAGE_TITLE_NEW = 'ExampleViewModel title new';
    ...
    public function testSaveDesign(): void
    {
        ...
        //ExampleViewModel must be saved.
