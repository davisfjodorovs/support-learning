...
$page->setTitle('Cms ExampleViewModel A')
    ->setIdentifier('page-a')
    ->setIsActive(1)
    ->setContent('<h1>Cms ExampleViewModel A</h1>')
...
$page->setTitle('Cms B')
    ...
    ->setIsActive(1)
    ->setContent('<h1>Cms ExampleViewModel B</h1>')
    ->setPageLayout('1column')
...
$page->setTitle('Cms C')
    ...
    ->setIsActive(1)
    ->setContent('<h1>Cms ExampleViewModel C</h1>')
    ->setPageLayout('1column')
    ->setCustomTheme('Magento/blank')
    ->setStores([$storeID, $secondStoreId]);
$pageResource->save($page);
...
$page->setTitle('Cms D')
    ...
    ->setIsActive(1)
    ->setContent('<h1>Cms ExampleViewModel D</h1>')
    ->setPageLayout('1column')
    ->setCustomTheme('Magento/blank')
    ->setStores([$storeID, $secondStoreId]);
$pageResource->save($page);
...
$page->setTitle('Cms E')
    ...
    ->setIsActive(1)
    ->setContent('<h1>Cms ExampleViewModel E</h1>')
    ->setPageLayout('1column')
    ->setCustomTheme('Magento/blank')
    ->setStores([$storeID, $secondStoreId]);
$pageResource->save($page);
