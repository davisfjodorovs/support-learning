    ...
    public function getData(): array
    {
        return [
            'type_drop_down_required' => [
                [
                    Option::KEY_TITLE => 'Xindex option drop-down title 1',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_DROP_DOWN,
                    Option::KEY_IS_REQUIRE => 1,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option drop-down title 1 value 1',
                    Value::KEY_PRICE => 10,
                ...
                [
                    ...
                    'title' => '<span>Xindex option drop-down title 1</span>',
            ...
            'type_drop_down_not_required' => [
                [
                    Option::KEY_TITLE => 'Xindex option drop-down title 2',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_DROP_DOWN,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option drop-down title 2 value 1',
                    Value::KEY_PRICE => 10,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    ...
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option drop-down title 2</span>',
                    'required_element' => '/<select/',
                    'option_value_item' => '/<option value="%s"  price="10" >%s \+\s{11}\$10.00.*/',
                    'not_contain_arr' => [
                        '/<select.*multiple="multiple"/',
            ...
            'type_drop_down_value_fixed_price' => [
                [
                    Option::KEY_TITLE => 'Xindex option drop-down title 3',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_DROP_DOWN,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option drop-down title 3 value 1',
                    Value::KEY_PRICE => 50,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option drop-down title 3</span>',
                    'required_element' => '/<select/',
            ...
            'type_drop_down_value_percent_price' => [
                [
                    Option::KEY_TITLE => 'Xindex option drop-down title 4',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_DROP_DOWN,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option drop-down title 4 value 1',
                    Value::KEY_PRICE => 50,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option drop-down title 4</span>',
                    'required_element' => '/<select/',
            ...
            'type_radio_button_required' => [
                [
                    Option::KEY_TITLE => 'Xindex option radio-button title 1',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_RADIO,
                    Option::KEY_IS_REQUIRE => 1,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option radio-button title 1 value 1',
                    Value::KEY_PRICE => 10,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    'block_with_required_class' => '<div class="field required">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option radio-button title 1</span>',
            ...
            'type_radio_button_not_required' => [
                [
                    Option::KEY_TITLE => 'Xindex option radio-button title 2',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_RADIO,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option radio-button title 2 value 1',
                    Value::KEY_PRICE => 10,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option radio-button title 2</span>',
                    'required_element' => '/<input type="radio"/',
                    'price' => 'data-price-amount="10"',
                ],
            ],
            'type_radio_button_value_fixed_price' => [
                [
                    Option::KEY_TITLE => 'Xindex option radio-button title 3',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_RADIO,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option radio-button title 3 value 1',
                    Value::KEY_PRICE => 50,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option radio-button title 3</span>',
                    'required_element' => '/<input type="radio"/',
            ...
            'type_radio_button_value_percent_price' => [
                [
                    Option::KEY_TITLE => 'Xindex option radio-button title 4',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_RADIO,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option radio-button title 4 value 1',
                    Value::KEY_PRICE => 50,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_PERCENT,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option radio-button title 4</span>',
                    'required_element' => '/<input type="radio"/',
            ...
            'type_checkbox_required' => [
                [
                    Option::KEY_TITLE => 'Xindex option checkbox title 1',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_CHECKBOX,
                    Option::KEY_IS_REQUIRE => 1,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option checkbox title 1 value 1',
                    Value::KEY_PRICE => 10,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    'block_with_required_class' => '<div class="field required">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option checkbox title 1</span>',
            ...
            'type_checkbox_not_required' => [
                [
                    Option::KEY_TITLE => 'Xindex option checkbox title 2',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_CHECKBOX,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option checkbox title 2 value 1',
                    Value::KEY_PRICE => 10,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option checkbox title 2</span>',
                    'required_element' => '/<input type="checkbox"/',
                    'price' => 'data-price-amount="10"',
                ],
            ],
            'type_checkbox_value_fixed_price' => [
                [
                    Option::KEY_TITLE => 'Xindex option checkbox title 3',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_CHECKBOX,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option checkbox title 3 value 1',
                    Value::KEY_PRICE => 50,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option checkbox title 3</span>',
                    'required_element' => '/<input type="checkbox"/',
                    'price' => 'data-price-amount="50"',
                ],
            ],
            'type_checkbox_value_percent_price' => [
                [
                    Option::KEY_TITLE => 'Xindex option checkbox title 4',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_CHECKBOX,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option checkbox title 4 value 1',
                    Value::KEY_PRICE => 50,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_PERCENT,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option checkbox title 4</span>',
                    'required_element' => '/<input type="checkbox"/',
                    'price' => 'data-price-amount="5"',
                ],
            ],
            'type_multiselect_required' => [
                [
                    Option::KEY_TITLE => 'Xindex option multiselect title 1',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_MULTIPLE,
                    Option::KEY_IS_REQUIRE => 1,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option multiselect title 1 value 1',
                    Value::KEY_PRICE => 10,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    'block_with_required_class' => '<div class="field required">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option multiselect title 1</span>',
            ...
            'type_multiselect_not_required' => [
                [
                    Option::KEY_TITLE => 'Xindex option multiselect title 2',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_MULTIPLE,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option multiselect title 2 value 1',
                    Value::KEY_PRICE => 10,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option multiselect title 2</span>',
                    'required_element' => '/<select.*multiple="multiple"/',
                    'option_value_item' => '/<option value="%s"  price="10" >%s \+\s{11}\$10.00.*/',
                ],
            ],
            'type_multiselect_value_fixed_price' => [
                [
                    Option::KEY_TITLE => 'Xindex option multiselect title 3',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_MULTIPLE,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option multiselect title 3 value 1',
                    Value::KEY_PRICE => 50,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_FIXED,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option multiselect title 3</span>',
                    'required_element' => '/<select.*multiple="multiple"/',
                    'option_value_item' => '/<option value="%s"  price="50" >%s \+\s{11}\$50.00.*/',
                ],
            ],
            'type_multiselect_value_percent_price' => [
                [
                    Option::KEY_TITLE => 'Xindex option multiselect title 4',
                    Option::KEY_TYPE => ProductCustomOptionInterface::OPTION_TYPE_MULTIPLE,
                    Option::KEY_IS_REQUIRE => 0,
                ],
                [
                    Value::KEY_TITLE => 'Xindex option multiselect title 4 value 1',
                    Value::KEY_PRICE => 50,
                    Value::KEY_PRICE_TYPE => ProductPriceOptionsInterface::VALUE_PERCENT,
                ...
                [
                    'block_with_required_class' => '<div class="field">',
                    'label_for_created_option' => '<label class="label" for="select_%s">',
                    'title' => '<span>Xindex option multiselect title 4</span>',
                    'required_element' => '/<select.*multiple="multiple"/',
                    'option_value_item' => '/<option value="%s"  price="5" >%s \+\s{11}\$5.00.*/',
                ],
            ],
