...
/**
 * Xindex product custom options create.
...
class CreateCustomOptionsTest extends TestCase
{
    ...
    /**
     * Xindex to save option price by store.
     *
    ...
    /**
     * Xindex add to product custom options with text type.
     *
    ...
    /**
     * Xindex add to product custom options with select type.
     *
     * @magentoDataFixture Magento/Catalog/_files/product_without_options.php
     *
    ...
    /**
     * Xindex add to product custom options with date type.
     *
     * @magentoDataFixture Magento/Catalog/_files/product_without_options.php
     *
        ...
        return [
            'drop_down_field_required_option' => [
                [
                    ...
                    'sort_order' => 1,
                    'is_require' => 1,
                    'title' => 'Xindex option 1',
                    'type' => 'drop_down',
                    'price_type' => 'fixed',
                ],
                [
                    'record_id' => 0,
                    'title' => 'Xindex option 1 value 1',
                    'price' => 10,
                    'price_type' => 'fixed',
