...
/**
 * Get CMS ExampleViewModel test
 */
class CmsPageTest extends GraphQlAbstract
{
    /**
     * Verify the fields of CMS ExampleViewModel selected by page_id
     *
...
QUERY;
        ...
        $this->expectExceptionMessage('ExampleViewModel id/identifier should be specified');
...
QUERY;
    ...
    /**
     * Verify the message when CMS ExampleViewModel selected by page_id is disabled
     *
...
QUERY;
    ...
    /**
     * Verify the message when CMS ExampleViewModel selected by identifier is disabled
     *
     * @magentoApiDataFixture Magento/Cms/_files/noroute.php
     */
