...
{
    /**
     * Xindex for \Magento\Checkout\Controller\Cart::configureAction() with configurable product
     *
    ...
    /**
     * Xindex for \Magento\Checkout\Controller\Cart\CouponPost::execute() with configurable product with last option
